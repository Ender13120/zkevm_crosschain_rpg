...
task(
  ...
  for (const file of files) {
    ...
    if (["AppStorage.json"].includes(jsonFile)) jsonFile = "Modifiers.json";
  ...
  fs.writeFileSync("./diamondABI/diamond_abi.json", abi);
  console.log("ABI written to diamondABI/diamond_abi.json");
});
